		...
		if($totalRegistros > 0 ){?>
			<table class="table table-hover">
				...
				<th scope="col">Data &amp; Hora</th>
					...
					<th scope="col-lg-2">Editar</th>
					<th scope="col-lg-2">Excluir</th>
				</tr>
				...
				<td>
				<button class="" data-cod="<?php echo $id ?>" data-obs="<?php echo $obs ?>" data-whatever="<?php echo $nome_cli ?>" data-target="#edit-modal" data-toggle="modal" style="color: black;">
				<i    class = " btn btn-dark fas fa-user-edit "></i>
				</button>
				</td>';
				<?php
				echo '<td>
				<a href="excluir.php" onclick="excluir({$row[0]})">
				<i style="color: black;" class="fas fa-trash-alt ml-3"></i>
				</a>
				</td>';
				echo '</tr>';
			 }
  ...
  <div class="modal-dialog" role="document">
    <div class="modal-content">
      ...
      <div class="modal-body">
        ...
        <input id="enviar" value="top" type="submit">
      </div>
